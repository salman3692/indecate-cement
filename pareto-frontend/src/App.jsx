...
export default function App() {
  ...
  const onGenerate = async () => {
    ...
    try {
      ...
      const res = await fetch('https://indecate-cement-244035f6986c.herokuapp.com/predict', { // online deployment
      // const res = await fetch('http://127.0.0.1:8000/predict', { // local deployment
        method: 'POST',
